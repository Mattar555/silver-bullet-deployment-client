...
### End of Error Message ###""".format(date_str,deployment_info['code_pkg_name'], receivers, stderr)
        ...
        if send_email_when_successful:
            ...
            message = """Subject: {} [{}] has completed successfully\r\n
...
### End of Message ###""".format(date_str,deployment_info['code_pkg_name'], receivers, stdout)
